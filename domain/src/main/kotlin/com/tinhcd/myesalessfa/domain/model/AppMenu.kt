...
object SupportedMenu {
    ...
    /** Entries inside a sheet. The first one this build actually has a screen for. */
     ...
     * because the sheet itself is the screen; of their children, only
     * [NEW_CUSTOMER] has one so far.
     */
